...
#define BTEN_Pin GPIO_PIN_7
#define BTEN_GPIO_Port GPIOA
#define LED0_Pin GPIO_PIN_0
#define LED0_GPIO_Port GPIOB
#define VOL__Pin GPIO_PIN_1
#define VOL__GPIO_Port GPIOB
#define VOL_B2_Pin GPIO_PIN_2
#define VOL_B2_GPIO_Port GPIOB
#define NEXT_Pin GPIO_PIN_12
#define NEXT_GPIO_Port GPIOB
#define PREV_Pin GPIO_PIN_13
#define PREV_GPIO_Port GPIOB
#define PLAY_Pin GPIO_PIN_14
